  ...
  return (
    <section className="min-h-[50vh] py-[50px] bg-linear-to-br from-[#0A0A0A] via-[#111827] to-[#000] flex flex-col justify-center lg:min-h-screen  lg:py-[111px]">
      ...
      >
        <motion.h3
          variants={fadeInUp}
          className="font-cairo   text-white text-center  font-black text-[1.89rem] leading-[2.13631rem] lg:text-[4rem] lg:leading-18"
        >
          كيف يعمل
        </motion.h3>
        <motion.p
          variants={fadeInUp}
          className="font-cairo  text-white text-center  max-w-[293px] w-full font-normal mt-[31px] mb-[53px] mx-auto text-[0.71213rem] leading-[0.97913rem] lg:mt-[55px] lg:mb-[52px] lg:max-w-[813px] lg:text-[1.5rem] lg:leading-8.25"
        >
      ...
      <div className="max-w-[1296px] w-full mx-auto px-4  ">
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          variants={staggerContainer}
          className=" hidden w-full lg:flex justify-center gap-[39px] "
        >
