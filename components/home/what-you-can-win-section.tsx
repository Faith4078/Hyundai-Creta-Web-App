...
export default function WhatYouCanWinSection() {
  return (
    <section className="min-h-screen pt-[76px] pb-[58px] bg-linear-to-br from-[#0A0A0A] via-[#111827] to-[#000] hidden lg:flex flex-col justify-center">
      <div className="space-y-[53px]">
        <h3 className="font-cairo text-[4rem] font-black leading-18 text-white text-center">
          ما يمكنك الفوز به
        </h3>
        <p className="font-cairo  font-normal text-white  text-center text-[0.71213rem] leading-[0.97913rem] lg:text-[1.5rem] lg:leading-8.25">
            ...
            return (
              ...
              >
                <div className="w-full h-full flex flex-col justify-evenly rounded-[13px] bg-[#0A0A0A] text-white font-normal font-cairo text-[1.5rem] hover:cursor-pointer">
                  ...
                  {list.map((item, index) => (
                    <ul
                      className="list-disc  ml-5 marker:text-white lg:mr-[50px]"
                      key={index}
                      dir="rtl"
                    >
      ...
      <button className="mx-auto mt-[78px] rounded-[100px] font-cairo text-[#1E293B]  font-extrabold  w-[393px] h-[82.59px] text-center flex justify-center items-center gap-[13px] bg-gradient-to-r from-[#3B82F6] to-[#0FF] text-[1.30275rem] leading-[3.90825rem] lg:text-[2rem] lg:leading-24  ">
        <Image
