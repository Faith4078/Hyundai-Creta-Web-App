...
export default function SignUpForm() {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-full order-2 lg:max-w-md lg:order-1"
    >
      <Card className="flex flex-col justify-center h-auto shadow-lg rounded-[15px] bg-gradient-to-r from-[#3B82F6] to-[#00FFFF] p-[1.5px] border-0">
        <motion.div
              ...
              <Field>
                ...
                <motion.div whileTap={{ scale: 0.995 }}>
                  <Input
                    id="lastName"
                    {...register('lastName')}
                    className="h-[52px]  bg-[#1E293B] border-0 transition-all duration-200"
                    autoComplete="off"
                    onBlur={() => trigger('lastName')}
                  />
                </motion.div>
